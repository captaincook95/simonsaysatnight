var combinationEncoded = -10161133;
...
var combinationDecoded = combinationEncoded + parseInt("" + code + 2*code + 3*code + 4*code);
  ...
  if (game.player[game.player.length - 1] !== game.currentGame[game.player.length - 1]) {
      ...
      if (check) {
        if(game.count == 7){
		  ...
		  location.href="coords.html?code=" + ("" + code + code*2 + code*3 + code*4);
        } else {
          //alert('Next round!');
          nextLevel();
        }
